...
# Home for {Epi::Dev::Io} module.
#
# Import this file to load {Epi::Dev::Io}.
...
module Epi::Dev
	...
	# an example of this mess. Epi::Dev::IO unifies these in a consistent set 
	# of idioms that should be quick to use and easy to remember. In summary:
	#
	# * IO is encapsulated in reader and writer objects. 
	# * Readers and Writers are constructed with either open IO handles or
	#   filepaths. Filepaths are converted to handles, opened and closed
	#   automatically.
	...
	#   rdr = Reader.new('file/path', {:mode=>'rb'})
	#   data = rdr.read()
	#   rdr.finish()
	#
